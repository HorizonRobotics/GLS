...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, return_plane = True, return_depth_normal = True, spe_tint=None, app_model=None):
    """
    Render the scene. 
    ...
    rendered_image, radii, rendered_objects, out_observe, out_all_map, plane_depth = rasterizer(
        means3D = means3D,
        means2D = means2D,
