...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        elif os.path.exists(os.path.join(args.source_path, "CameraTrajectory.txt")):
            print("Found CameraTrajectory.txt file, assuming ORB data set!")
            scene_info = sceneLoadTypeCallbacks["ORB"](args.source_path, args.images, args.eval)
        elif os.path.exists(os.path.join(args.source_path, "vc_params.json")):
            print("Found CameraTrajectory.txt file, assuming VC data set!")
            scene_info = sceneLoadTypeCallbacks["VC"](args.source_path, args.images, args.eval)
        else:
